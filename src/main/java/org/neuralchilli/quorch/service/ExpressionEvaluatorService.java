...
import org.neuralchilli.quorch.domain.ExpressionContext;
import org.neuralchilli.quorch.util.DateFunctions;
import org.neuralchilli.quorch.util.StringFunctions;
...
public class ExpressionEvaluatorService {
    ...
    private static final Logger log = LoggerFactory.getLogger(ExpressionEvaluatorService.class);
