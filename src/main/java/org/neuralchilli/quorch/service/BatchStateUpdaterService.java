...
import org.neuralchilli.quorch.domain.TaskExecutionLookupKey;
 ...
 */
@ApplicationScoped
public class BatchStateUpdaterService {

    private static final Logger log = LoggerFactory.getLogger(BatchStateUpdaterService.class);
